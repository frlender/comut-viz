export default function InputHelp(){
    return <div className='help-container'>
        <div className="help-row">Comut-viz is an online tool to generate comutation plot, which delivers a global view of the mutation landascape of large-scale genomic studies. It accpets a table of mutation data as input, interactively filters it and visualize the top mutated genes in a customizable comutation plot. 
        </div>
