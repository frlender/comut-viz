export default function InputHelp(){
    return <div className='help-container'>
        ...
        <div className="help-row">The app will automatically ignore comment lines starting with "#" in the input files. If there are comment lines in other formats, please delete them before submitting to the app.</div>
        <div className="help-row"> Users can test the app using the two example buttons. One loads a mutationa data file with 5k rows and its associated metadata, and the other loads a large mutation file with 141k rows.</div>
